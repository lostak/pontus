...
import VelaChainPontusVelaChainPontusSea from './VelaChain/pontus/VelaChain.pontus.sea'
...
export default { 
  VelaChainPontusVelaChainPontusSea: load(VelaChainPontusVelaChainPontusSea, 'VelaChain.pontus.sea'),
